...
export const VideoMergeJobDataSchema = z.object({
  videos: z
    .array(
      z.object({
        url: z.string().url(),
    ...
    .min(2)
    .max(50),
  transition: z.enum(['none', 'crossfade', 'fade']).default('none'),
...
export type VideoMergeJobData = z.infer<typeof VideoMergeJobDataSchema>;
