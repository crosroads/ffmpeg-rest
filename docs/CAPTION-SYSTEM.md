...
Style: Default,${fontFamily},${fontSize},${primaryColor},${highlightColor},${outlineColor},&H80000000,-1,0,0,0,100,100,0,0,1,3,2,2,10,10,${marginBottom},1
                                                                                                                         ↑ 3px outline (optimized for mobile readability)
